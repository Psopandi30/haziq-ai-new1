...
const App: React.FC = () => {
  ...
  const renderLanding = () => (
    <div className="flex-1 flex flex-col items-center justify-center w-full max-w-5xl mx-auto px-6 relative">
      ...
      {/* Modern Input Bar */}
      <div className="w-full max-w-3xl relative z-10 mb-16 animate-in fade-in zoom-in-95 duration-1000 delay-100">
        <div className="group relative bg-white rounded-[2rem] p-2 pr-2 pl-6 shadow-2xl shadow-slate-200/50 flex items-center gap-4 transition-all hover:shadow-[0_20px_40px_-15px_rgba(15,76,58,0.15)] ring-1 ring-slate-100 focus-within:ring-2 focus-within:ring-[#0f4c3a]/20">
          ...
          <input
            ...
            className="flex-1 bg-transparent border-none outline-none text-lg text-slate-700 placeholder-slate-400 font-medium h-14"
          />
          <button
            onClick={() => handleSend(inputText)}
            className="w-14 h-14 bg-[#0f4c3a] text-white rounded-[1.5rem] flex items-center justify-center transition-transform hover:scale-105 active:scale-95 shadow-lg shadow-[#0f4c3a]/20"
          >
      ...
      {/* Quick Cards Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-4xl animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-200">
