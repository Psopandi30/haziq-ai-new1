...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, onProfileClick, onNewChat, user }) => {
  const [historyItems, setHistoryItems] = useState<HistoryItem[]>([
    { id: 1, title: 'Ilmu fiqih islam dan penerapannya', date: 'Hari ini' },
    { id: 2, title: 'Tafsir surat Al-Baqarah ayat 255', date: 'Kemarin' },
    { id: 3, title: 'Metodologi penelitian kualitatif', date: '2 hari lalu' },
  ]);
                ...
                historyItems.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-slate-700 text-sm font-medium truncate">{item.title}</p>
