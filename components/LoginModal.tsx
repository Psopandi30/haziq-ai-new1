...
import { X, User, Lock, GraduationCap, ChevronRight } from 'lucide-react';
...
export const LoginModal: React.FC<LoginModalProps> = ({ onClose, onLogin, onRegister }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (isRegistering) {
        onRegister({ nim, password, name, prodi, username });
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center px-4">
      ...
      <div className="bg-white rounded-[2rem] w-full max-w-sm p-8 relative z-10 shadow-2xl animate-in zoom-in-95 duration-300">
